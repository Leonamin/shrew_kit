...
class EventDrawProperties {
  ...
  EventDrawProperties(DailyScheduleView dayView, Schedule event, this.isRTL) {
  ...
  Widget createWidget(BuildContext context, DailyScheduleView dayView,
      Widget? resizeGestureDetector, Schedule event) {
